...
Root Cause:
Testbench was driving rd_en on negedge
...
Xcelium:
bash
xrun -sv rtl/sync_fifo.sv tb/tb_sync_fifo.sv -access +rwc

Waveforms & Debug

Read Latency Observation
(see docs/waveform_read_delay.png)

Assertion Failure Example
(see docs/assertion_failure.png)
